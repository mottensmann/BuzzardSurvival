...
models <- data.frame(model.number = 1:(length(models.barker.adj) - 1),
                     model = sapply(models.barker.adj[1:544], function(x) x[["model.name"]]))
...
```{r, echo=T, eval=F}
ggsave(plot = Fig_2_new, filename =  "plots/Fig_2NEW.pdf", 
        device = "pdf", dpi = 1200, width = 6, height = 6, units = "in")
ggsave(plot = Fig_2_new, filename = "plots/Fig_2NEW.png", 
        device = "png", dpi = 1200, width = 6, height = 6, units = "in")
